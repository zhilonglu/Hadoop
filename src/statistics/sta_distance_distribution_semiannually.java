...
*/
public class sta_distance_distribution_semiannually {
	...
	{  
		...
		public TblsWritable(int id,double sta_year,double sta_halfyear,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.id +" "+ this.sta_year +" "+this.sta_halfyear+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_semiannually");  
		job.setJarByClass(sta_distance_distribution_semiannually.class);  

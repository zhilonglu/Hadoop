...
*/
public class sta_passenger_satisfaction_daily {
	...
	{  
		...
		double passenger_satisfaction;//订单总数
		int crest_segment_id;//峰段标识
		String crest_segment_name;//峰段名称
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int sta_satisfaction_id,String sta_date,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.passenger_satisfaction);
		...
		{  
			...
			this.passenger_satisfaction = resultSet.getDouble(11);
		...
		{  
			return new String(this.sta_satisfaction_id +" "+ this.sta_date +" "+this.date_type+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_daily");  
		job.setJarByClass(sta_passenger_satisfaction_daily.class);  

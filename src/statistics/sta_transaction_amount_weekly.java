...
*/
public class sta_transaction_amount_weekly {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,double sta_year,double sta_month,double sta_week,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(13, this.order_transaction_amount_total);
			statement.setDouble(14,this.enterprise_income);
			statement.setDouble(15, this.driver_income);
		...
		{  
			...
			this.order_transaction_amount_total = resultSet.getDouble(13);
			this.enterprise_income = resultSet.getDouble(14);
			this.driver_income = resultSet.getDouble(15);
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_year +" "+this.sta_month+" "+this.sta_week+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_weekly");  
		job.setJarByClass(sta_transaction_amount_weekly.class);  

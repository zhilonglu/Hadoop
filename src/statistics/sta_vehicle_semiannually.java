...
public class sta_vehicle_semiannually {
	...
	{  
		...
		{  
			...
			this.sta_halfyear = sta_halfyear;
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_vehicle_semiannually");  
		job.setJarByClass(sta_vehicle_semiannually.class);  

...
public class sta_vehicle_weekly {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(13, this.dispatch_vehicle_number);
			statement.setDouble(14, this.register_vehicle_number);
			statement.setDouble(15, this.bus_operating_rate);
			statement.setInt(16, crest_segment_id);
			statement.setString(17, crest_segment_name);
		}  
		@Override  
		...
		{  
			...
			this.dispatch_vehicle_number = resultSet.getDouble(13);
			this.register_vehicle_number = resultSet.getDouble(14);
			this.bus_operating_rate = resultSet.getDouble(15);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_vehicle_weekly");  
		job.setJarByClass(sta_vehicle_weekly.class);  

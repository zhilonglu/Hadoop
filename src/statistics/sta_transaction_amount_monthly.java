...
*/
public class sta_transaction_amount_monthly {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(12, this.order_transaction_amount_total);
			statement.setDouble(13,this.enterprise_income);
			statement.setDouble(14, this.driver_income);
		...
		{  
			...
			this.driver_income = resultSet.getDouble(14);
		...
		{  
			...
			this.belong_country+" "+this.order_transaction_amount_total +" "+
			this.enterprise_income+" "+this.driver_income+" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_monthly");  
		job.setJarByClass(sta_transaction_amount_monthly.class);  

...
*/
public class sta_transaction_amount_halfhour {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,String sta_date,String date_type,String sta_halfhour
				...
				double order_transaction_amount_total,double enterprise_income,double driver_income) 
		{  
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_date +" "+this.date_type+" "+this.sta_halfhour
			+" "+this.belong_enterprise_id +" "+this.belong_enterprise+" "+this.regionalism_code+" "+
			this.reionalism_name+" "+this.belong_province+" "+this.belong_city+" "+this.belong_country+" "+this.order_transaction_amount_total+
			" "+this.enterprise_income+" "+this.driver_income);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_halfhour");  
		job.setJarByClass(sta_transaction_amount_halfhour.class);  

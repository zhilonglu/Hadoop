...
public class sta_order_yearly {
	...
	{  
		...
		double order_total;//订单总数
		double order_complete_total;//订单完成熟
		double order_complete_rate;//订单完成率
		int crest_segment_id;//峰段标识
		String crest_segment_name;//峰段名称
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int id,Double sta_year,String date_type,String sta_hour,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.order_total);
			statement.setDouble(12, this.order_complete_total);
			statement.setDouble(13, this.order_complete_rate);
		...
		{  
			...
			this.order_total = resultSet.getDouble(11);
			this.order_complete_total = resultSet.getDouble(12);
			this.order_complete_rate = resultSet.getDouble(13);
		...
		{  
			...
			this.belong_country+" "+this.order_total+" "+
			this.order_complete_total +" "+this.order_complete_rate+" "+this.crest_segment_id+" "+this.crest_segment_name);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_order_yearly");  
		job.setJarByClass(sta_order_yearly.class);  

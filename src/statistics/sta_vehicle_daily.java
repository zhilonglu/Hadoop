...
*/
public class sta_vehicle_daily {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.dispatch_vehicle_number);
			statement.setDouble(12, this.register_vehicle_number);
			statement.setDouble(13, this.bus_operating_rate);
		...
		{  
			...
			this.dispatch_vehicle_number = resultSet.getDouble(11);
			this.register_vehicle_number = resultSet.getDouble(12);
			this.bus_operating_rate = resultSet.getDouble(13);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_vehicle_daily");  
		job.setJarByClass(sta_vehicle_daily.class);  
		...
		DBOutputFormat.setOutput(job, "sta_vehicle_daily", "grid","vehNo","sTime","carNum");

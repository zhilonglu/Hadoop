...
*/
public class sta_transaction_amount_quarterly {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,double sta_year,double sta_quarter,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_year +" "+this.sta_quarter+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_quarterly");  
		job.setJarByClass(sta_transaction_amount_quarterly.class);  

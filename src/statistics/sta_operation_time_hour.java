...
*/
public class sta_operation_time_hour {
	...
	{  
		...
		public TblsWritable(int sta_operation_time_id,String sta_date,String date_type,String sta_hour,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_operation_time_id +" "+ this.sta_date +" "+this.date_type+" "+this.sta_hour+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_operation_time_hour");  
		job.setJarByClass(sta_operation_time_hour.class);  

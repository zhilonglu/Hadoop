...
*/
public class sta_passenger_satisfaction_semiannually {
	...
	{  
		...
		public TblsWritable(int sta_satisfaction_id,double sta_year,double sta_halfyear,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double passenger_satisfaction,int crest_segment_id,String crest_segment_name) 
		{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(12, passenger_satisfaction);
		...
		{  
			...
			this.passenger_satisfaction = resultSet.getDouble(12);
		...
		{  
			return new String(this.sta_satisfaction_id +" "+ this.sta_year +" "+this.sta_halfyear+" "+this.date_type+" "+
			...
			this.belong_country+" "+this.passenger_satisfaction+" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_semiannually");  
		job.setJarByClass(sta_passenger_satisfaction_semiannually.class);  

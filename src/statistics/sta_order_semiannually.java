...
*/
public class sta_order_semiannually {
	...
	{  
		...
		double order_complete_rate;//平均运距
		int crest_segment_id;//峰段标识
		String crest_segment_name;//峰段名称
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int id,double sta_year,String sta_halfyear,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double order_complete_total,double order_total,double order_complete_rate,int crest_segment_id,String crest_segment_name) 
		{  
			this.id = id;//标识  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setString(3, this.sta_halfyear);
		...
		{  
			...
			this.sta_halfyear = resultSet.getString(3);
		...
		{  
			...
			out.writeUTF(this.sta_halfyear);
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_order_semiannually");  
		job.setJarByClass(sta_order_semiannually.class);  

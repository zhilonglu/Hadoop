...
*/
public class sta_passenger_satisfaction_quarterly {
	...
	{  
		...
		public TblsWritable(int sta_satisfaction_id,double sta_year,double sta_quarter,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_satisfaction_id +" "+ this.sta_year +" "+this.sta_quarter+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_quarterly");  
		job.setJarByClass(sta_passenger_satisfaction_quarterly.class);  

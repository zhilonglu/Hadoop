...
*/
public class sta_avg_order_amount_yearly {
	...
	{  
		...
		double order_complete_avg_amount;
		int crest_segment_id;
		String crest_segment_name;
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int id,double sta_year,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.order_complete_total);
			statement.setDouble(12, this.order_complete_amount);
			statement.setDouble(13, this.order_complete_avg_amount);
		...
		{  
			...
			this.order_complete_total = resultSet.getDouble(11);
			this.order_complete_amount = resultSet.getDouble(12);
			this.order_complete_avg_amount = resultSet.getDouble(13);
		...
		{  
			...
			out.writeUTF(crest_segment_name);
		}  
		@Override  
		...
		{  
			return new String(this.id +" "+ this.sta_year +" "+this.date_type+" "+
			...
			this.crest_segment_id+" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_order_amount_yearly");  
		job.setJarByClass(sta_avg_order_amount_yearly.class);  

...
*/
public class sta_avg_order_amount_weekly {
	...
	{  
		...
		double order_complete_total;
		double order_complete_amount;
		double order_complete_avg_amount;//总订单数
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(14, this.order_complete_amount);
			statement.setDouble(15, this.order_complete_avg_amount);
		...
		{  
			...
			this.order_complete_amount = resultSet.getDouble(14);
			this.order_complete_avg_amount = resultSet.getDouble(15);
		...
		{  
			...
			this.belong_country+" "+this.order_complete_total+" "+this.order_complete_amount+" "+
			this.order_complete_avg_amount +" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_order_amount_weekly");  
		job.setJarByClass(sta_avg_order_amount_weekly.class);  

...
*/
public class sta_distance_distribution_weekly {
	...
	{  
		...
		public TblsWritable(int id,double sta_year,double sta_month,double sta_week,String date_type,int belong_enterprise_id,String belong_enterprise
				...
				String distance_range,double avg_work_time,int crest_segment_id,String crest_segment_name) 
		{  
			this.id = id;//标识  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setString(13, this.distance_range);
		...
		{  
			...
			this.distance_range = resultSet.getString(13);
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_weekly");  
		job.setJarByClass(sta_distance_distribution_weekly.class);  

...
*/
public class sta_distance_distribution_yearly {
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_yearly");  
		job.setJarByClass(sta_distance_distribution_yearly.class);  

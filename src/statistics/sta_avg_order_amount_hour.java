...
*/
public class sta_avg_order_amount_hour {
	...
	{  
		...
		public TblsWritable(int id,String sta_date,String date_type,int belong_enterprise_id,String belong_enterprise
				,String sta_hour,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double order_complete_total,double order_complete_amount,double order_complete_avg_amount) 
		{  
			this.id = id;//标识  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setString(6, this.sta_hour);
		...
		{  
			...
			this.sta_hour = resultSet.getString(6);
		...
		{  
			return new String(this.id +" "+ this.sta_date +" "+this.date_type+" "+
			this.belong_enterprise_id +" "+this.belong_enterprise+" "+this.sta_hour+" "+this.regionalism_code+" "+
			this.reionalism_name+" "+this.belong_province+" "+this.belong_city+" "+
			this.belong_country+" "+this.order_complete_total+" "+
			this.order_complete_amount +" "+this.order_complete_avg_amount);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_order_amount_hour");  
		job.setJarByClass(sta_avg_order_amount_hour.class);  

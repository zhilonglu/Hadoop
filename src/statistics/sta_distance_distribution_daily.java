...
*/
public class sta_distance_distribution_daily {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setString(11, this.distance_range);
			statement.setInt(12,crest_segment_id);
			statement.setString(13,crest_segment_name);
		}  
		@Override  
		...
		{  
			...
			this.distance_range = resultSet.getString(11);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_daily");  
		job.setJarByClass(sta_distance_distribution_daily.class);  

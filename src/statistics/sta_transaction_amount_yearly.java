...
*/
public class sta_transaction_amount_yearly {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,double sta_year,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_year +" "+this.date_type+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_yearly");  
		job.setJarByClass(sta_transaction_amount_yearly.class);  

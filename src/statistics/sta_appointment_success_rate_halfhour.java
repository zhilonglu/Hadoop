...
*/
public class sta_appointment_success_rate_halfhour {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,String sta_date,String date_type,String sta_halfhour,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_appointment_success_id +" "+ this.sta_date +" "+this.date_type+" "+this.sta_halfhour+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_halfhour");  
		job.setJarByClass(sta_appointment_success_rate_halfhour.class);  

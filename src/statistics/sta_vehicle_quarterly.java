...
public class sta_vehicle_quarterly {
	...
	{  
		...
		public TblsWritable(int id,double sta_year,double sta_quarterly,String date_type,int belong_enterprise_id,String belong_enterprise,
				...
				double dispatch_vehicle_number,double register_vehicle_number,double bus_operating_rate,int crest_segment_id,String crest_segment_name) 
		{  
			this.id = id;//标识  
			this.sta_year = sta_year; //统计运距统计日期
			this.sta_quarterly = sta_quarterly;
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setInt(15, crest_segment_id);
			statement.setString(16, crest_segment_name);
		}  
		@Override  
		...
		{  
			...
			this.register_vehicle_number +" "+this.bus_operating_rate+" "+ this.crest_segment_id+" "+this.crest_segment_name);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_vehicle_quarterly");  
		job.setJarByClass(sta_vehicle_quarterly.class);  

...
*/
public class sta_passenger_satisfaction_weekly {
	...
	{  
		...
		public TblsWritable(int sta_satisfaction_id,double sta_year,double sta_month,double sta_week,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(13, this.passenger_satisfaction);
		...
		{  
			...
			this.passenger_satisfaction = resultSet.getDouble(13);
		...
		{  
			return new String(this.sta_satisfaction_id +" "+ this.sta_year +" "+this.sta_month+" "+this.sta_week+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_weekly");  
		job.setJarByClass(sta_passenger_satisfaction_weekly.class);  

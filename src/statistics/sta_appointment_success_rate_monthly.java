...
*/
public class sta_appointment_success_rate_monthly {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,double sta_year,double sta_month,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			...
			this.sta_month = sta_month; //统计运距统计日期
		...
		{  
			return new String(this.sta_appointment_success_id +" "+ this.sta_year +" "+this.sta_month+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_monthly");  
		job.setJarByClass(sta_appointment_success_rate_monthly.class);  

...
*/
public class sta_appointment_success_rate_weekly {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,double sta_year,double sta_month,double sta_week,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(3, sta_month);
			...
			statement.setDouble(13, this.appointment_success_rate);
			statement.setInt(14, this.crest_segment_id);
			statement.setString(15, this.crest_segment_name);
		}  
		@Override  
		public void readFields(ResultSet resultSet) throws SQLException 
		{  
			this.sta_appointment_success_id = resultSet.getInt(1);//标识  
			this.sta_year = resultSet.getDouble(2); 
			...
			this.appointment_success_rate = resultSet.getDouble(13);
		...
		{  
			return new String(this.sta_appointment_success_id +" "+ this.sta_year +" "+this.sta_month+" "+this.sta_week+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_weekly");  
		job.setJarByClass(sta_appointment_success_rate_weekly.class);  

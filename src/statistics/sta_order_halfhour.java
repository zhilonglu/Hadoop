...
*/
public class sta_order_halfhour {
	...
	{  
		...
		public TblsWritable(int id,String sta_date,String date_type,int belong_enterprise_id,String belong_enterprise,String sta_halfhour
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double order_total,double order_complete_total,double order_complete_rate) 
		{  
			this.id = id;//标识  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setString(6,this.sta_halfhour);
		...
		{  
			...
			this.sta_halfhour = resultSet.getString(6);
		...
		{  
			...
			this.belong_enterprise_id +" "+this.belong_enterprise+" "+this.sta_halfhour+" "+this.regionalism_code+" "+
			this.reionalism_name+" "+this.belong_province+" "+this.belong_city+" "+
			this.belong_country+" "+this.order_total+" "+
			this.order_complete_total +" "+this.order_complete_rate);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_order_halfhour");  
		job.setJarByClass(sta_order_halfhour.class);  

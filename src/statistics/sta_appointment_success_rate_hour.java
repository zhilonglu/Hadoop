...
*/
public class sta_appointment_success_rate_hour {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,String sta_date,String date_type,String sta_hour,int belong_enterprise_id,String belong_enterprise
		...
		{  
			...
			" "+this.sta_hour+" "+this.belong_enterprise_id +" "+this.belong_enterprise+" "+this.regionalism_code+" "+
			this.reionalism_name+" "+this.belong_province+" "+this.belong_city+" "+
			this.belong_country+" "+this.appointment_success_rate); 
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_hour");  
		job.setJarByClass(sta_appointment_success_rate_hour.class);  

...
*/
public class sta_transaction_amount_hour {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,String sta_date,String date_type,String sta_hour,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,double order_transaction_amount_total,
				double enterprise_income,double driver_income) 
		{  
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_date +" "+this.date_type+" "+this.sta_hour+" "+
			...
			this.belong_country+" "+this.order_transaction_amount_total+" "+this.enterprise_income+" "+this.driver_income);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_hour");  
		job.setJarByClass(sta_transaction_amount_hour.class);  

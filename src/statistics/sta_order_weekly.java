...
public class sta_order_weekly {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(14, this.order_complete_total);
			statement.setDouble(15, this.order_complete_rate);
		...
		{  
			...
			this.order_complete_total = resultSet.getDouble(14);
			this.order_complete_rate = resultSet.getDouble(15);
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_order_weekly");  
		job.setJarByClass(sta_order_weekly.class);  

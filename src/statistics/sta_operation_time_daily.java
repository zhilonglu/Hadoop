...
*/
public class sta_operation_time_daily {
	...
	{  
		...
		public TblsWritable(int sta_operation_time_id,String sta_date,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double avg_dispatch_vehicle_time,double avg_work_time,double order_complete_rate,int crest_segment_id,String crest_segment_name) 
		{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.avg_dispatch_vehicle_time);
			statement.setDouble(12, this.avg_work_time);
			statement.setInt(13,crest_segment_id);
			statement.setString(14,crest_segment_name);
		}  
		@Override  
		...
		{  
			...
			this.avg_dispatch_vehicle_time = resultSet.getDouble(11);
			this.avg_work_time = resultSet.getDouble(12);
		...
		{  
			return new String(this.sta_operation_time_id +" "+ this.sta_date +" "+this.date_type+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_operation_time_daily");  
		job.setJarByClass(sta_operation_time_daily.class);  

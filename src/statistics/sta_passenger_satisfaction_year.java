...
*/
public class sta_passenger_satisfaction_year {
	...
	{  
		...
		public TblsWritable(int sta_satisfaction_id,double sta_year,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.sta_satisfaction_id +" "+ this.sta_year +" "+this.date_type+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_year");  
		job.setJarByClass(sta_passenger_satisfaction_year.class);  

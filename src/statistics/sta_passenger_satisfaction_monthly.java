...
*/
public class sta_passenger_satisfaction_monthly {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,double sta_year,double sta_month,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(12, this.passenger_satisfaction);
		...
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_year +" "+this.sta_month+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_passenger_satisfaction_monthly");  
		job.setJarByClass(sta_passenger_satisfaction_monthly.class);  

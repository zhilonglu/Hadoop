...
*/
public class sta_avg_distance_quarterly {
	...
	{  
		...
		public TblsWritable(int id,double sta_year,double sta_quarerly,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			...
			this.sta_quarerly = sta_quarerly; //统计运距统计日期
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(3, this.sta_quarerly);
		...
		{  
			...
			this.sta_quarerly = resultSet.getDouble(3);
		...
		{  
			...
			out.writeDouble(this.sta_quarerly);
		...
		{  
			...
			this.sta_quarerly = in.readDouble();
		...
		{  
			return new String(this.id +" "+ this.sta_year +" "+this.sta_quarerly+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_distance_quarterly");  
		job.setJarByClass(sta_avg_distance_quarterly.class);  

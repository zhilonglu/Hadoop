...
*/
public class sta_distance_distribution_halfhour {
	...
	{  
		...
		{  
			...
			this.belong_country+" "+this.distance_range);  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_halfhour");  
		job.setJarByClass(sta_distance_distribution_halfhour.class);  

...
*/
public class sta_avg_distance_semiannually {
	...
	{  
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(12, this.carry_passenger_distance_total);
			statement.setDouble(13, this.order_total);
			statement.setDouble(14, this.avg_distance);
		...
		{  
			...
			this.carry_passenger_distance_total = resultSet.getDouble(12);
			this.order_total = resultSet.getDouble(13);
			this.avg_distance = resultSet.getDouble(14);
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_distance_semiannually");  
		job.setJarByClass(sta_avg_distance_semiannually.class);  

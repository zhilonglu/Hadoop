...
*/
public class sta_avg_distance_halfhour {
	...
	{  
		...
		public TblsWritable(int id,String sta_date,String date_type,String sta_halfhour,int belong_enterprise_id,String belong_enterprise
				...
				double carry_passenger_distance_total,double order_total,double avg_distance) 
		{  
			this.id = id;//标识  
		...
		{  
			...
			this.order_total +" "+this.avg_distance +" ");  
		}  
	} 
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_distance_halfhour");  
		job.setJarByClass(sta_avg_distance_halfhour.class);  

...
*/
public class sta_appointment_success_rate_year {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,double sta_year,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		{  
			...
			this.sta_year = sta_year; //统计运距统计日期
		...
		{  
			return new String(this.sta_appointment_success_id +" "+ this.sta_year +" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_year");  
		job.setJarByClass(sta_appointment_success_rate_year.class);  

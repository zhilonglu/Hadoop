...
*/
public class sta_appointment_success_rate_daily {
	...
	{  
		...
		public TblsWritable(int sta_appointment_success_id,String sta_date,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(11, this.appointment_success_rate);
			statement.setInt(12,this.crest_segment_id);
			statement.setString(13,this.crest_segment_name);
		}  
		@Override  
		...
		{  
			...
			this.appointment_success_rate = resultSet.getDouble(11);
			this.crest_segment_id = resultSet.getInt(12);
			this.crest_segment_name = resultSet.getString(13);
		}  
		@Override  
		...
		{  
			return new String(this.sta_appointment_success_id +" "+ this.sta_date +" "+this.date_type+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_appointment_success_rate_daily");  
		job.setJarByClass(sta_appointment_success_rate_daily.class);  

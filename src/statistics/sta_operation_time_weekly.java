...
*/
public class sta_operation_time_weekly {
	...
	{  
		...
		public TblsWritable(int sta_operation_time_id,double sta_year,double sta_month,double sta_week,String date_type,int belong_enterprise_id,String belong_enterprise
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(13, this.avg_dispatch_vehicle_time);
			statement.setDouble(14, this.avg_work_time);
		...
		{  
			...
			this.avg_dispatch_vehicle_time = resultSet.getDouble(13);
			this.avg_work_time = resultSet.getDouble(14);
		...
		{  
			return new String(this.sta_operation_time_id +" "+ this.sta_year +" "+this.sta_month+" "+this.sta_week+" "+this.date_type+" "+
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_operation_time_weekly");  
		job.setJarByClass(sta_operation_time_weekly.class);  

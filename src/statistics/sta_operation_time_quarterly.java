...
*/
public class sta_operation_time_quarterly {
	...
	{  
		...
		double avg_dispatch_vehicle_time;//总载客距离
		double avg_work_time;//总订单数
		int crest_segment_id;//峰段标识
		String crest_segment_name;//峰段名称
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int sta_operation_time_id,double sta_year,double sta_quarterly,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double avg_dispatch_vehicle_time,double avg_work_time,int crest_segment_id,String crest_segment_name) 
		{  
		...
		{  
			return new String(this.sta_operation_time_id +" "+ this.sta_year +" "+this.sta_quarterly+" "+this.date_type+" "+
			...
			this.avg_work_time +" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_operation_time_quarterly");  
		job.setJarByClass(sta_operation_time_quarterly.class);  

...
public class sta_order_daily {
	...
	{  
		...
		public TblsWritable(int id,String sta_date,String date_type,String sta_hour,int belong_enterprise_id,String belong_enterprise
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_order_daily");  
		job.setJarByClass(sta_order_daily.class);  

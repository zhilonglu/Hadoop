...
*/
public class sta_transaction_amount_semiannually {
	...
	{  
		...
		public TblsWritable(int sta_transaction_amount_id,double sta_year,double sta_halfyear,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				double order_transaction_amount_total,double enterprise_income,double drive_income,int crest_segment_id,String crest_segment_name) 
		{  
			this.sta_transaction_amount_id = sta_transaction_amount_id;//标识  
			this.sta_year = sta_year;
			this.sta_halfyear = sta_halfyear; //统计运距统计日期
			...
			this.drive_income = drive_income;
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(3, this.sta_halfyear);
			...
			statement.setDouble(12, order_transaction_amount_total);
			statement.setDouble(13, this.enterprise_income);
			statement.setDouble(14,this.drive_income);
		...
		{  
			...
			this.sta_halfyear = resultSet.getDouble(3);
			...
			this.order_transaction_amount_total = resultSet.getDouble(12);
			this.enterprise_income = resultSet.getDouble(13);
			this.drive_income = resultSet.getDouble(14);
		...
		{  
			...
			out.writeDouble(this.sta_halfyear);
			...
			out.writeDouble(this.drive_income);
		...
		{  
			...
			this.sta_halfyear = in.readDouble();
			...
			this.drive_income = in.readDouble();
			this.crest_segment_id = in.readInt();
			this.crest_segment_name = in.readUTF(); 
		}  
		public String toString() 
		{  
			return new String(this.sta_transaction_amount_id +" "+ this.sta_year +" "+this.sta_halfyear+" "+this.date_type+" "+
			...
			this.belong_country+" "+this.order_transaction_amount_total+" "+this.enterprise_income +" "+this.drive_income+" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_transaction_amount_semiannually");  
		job.setJarByClass(sta_transaction_amount_semiannually.class);  

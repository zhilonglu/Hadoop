...
*/
public class sta_avg_order_amount_halfhour {
	...
	{  
		...
		public TblsWritable(int id,String sta_date,String date_type,String sta_halfhour,int belong_enterprise_id,String belong_enterprise
		...
		{  
			return new String(this.id +" "+ this.sta_date +" "+this.date_type+" "+this.sta_halfhour+" "+
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_avg_order_amount_halfhour");  
		job.setJarByClass(sta_avg_order_amount_halfhour.class);  

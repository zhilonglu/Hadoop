...
public class sta_distance_distribution_quarterly {
	...
	{  
		...
		String distance_range;//总载客距离
		int crest_segment_id;//峰段标识
		String crest_segment_name;//峰段名称
		public TblsWritable() 
		{  
		}  
		public TblsWritable(int id,double sta_year,double sta_quarterly,String date_type,int belong_enterprise_id,String belong_enterprise
				,String regionalism_code,String reionalism_name,String belong_province,String belong_city,String belong_country,
				String distance_range,int crest_segment_id,String crest_segment_name) 
		{  
			this.id = id;//标识  
			this.sta_year = sta_year;
			this.sta_quarterly = sta_quarterly; //统计运距统计日期
		...
		public void write(PreparedStatement statement) throws SQLException 
		{
			...
			statement.setDouble(3, this.sta_quarterly);
			...
			statement.setString(12, this.distance_range);
		...
		{  
			...
			this.sta_quarterly = resultSet.getDouble(3);
			...
			this.distance_range = resultSet.getString(12);
		...
		{  
			...
			out.writeDouble(this.sta_quarterly);
			...
			out.writeUTF(this.distance_range);
		...
		{  
			...
			this.sta_quarterly = in.readDouble();
			...
			this.distance_range = in.readUTF();
			this.crest_segment_id = in.readInt();
			this.crest_segment_name = in.readUTF(); 
		}  
		public String toString() 
		{  
			return new String(this.id +" "+ this.sta_year +" "+this.sta_quarterly+" "+this.date_type+" "+
			...
			this.belong_country+" "+this.distance_range+" "+this.crest_segment_id +" "+this.crest_segment_name);  
		}  
	} 
...
//					context.write(new TblsWritable(keyData[0],keyData[1],string.getKey().toString(),Integer.valueOf(string.getValue().toString())), null);
	...
	public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Job job = new Job(conf,"sta_distance_distribution_quarterly");  
		job.setJarByClass(sta_distance_distribution_quarterly.class);  
